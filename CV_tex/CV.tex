...
\section{Service}
    ...
    \resumeField
      ...
      {JGR: Solid Earth, Nature Geoscience, Geophysical Research Letters, Science Advances}
    \resumeSmallThing
      {Co-chair, Standards and Copy Editing}{\textit{Seismica} journal}{2022-present}
    \resumeSmallThing
      {WHOI Postdoc Association department representative}{Secretary and WCC rep}{2022-present}
    \resumeSmallThing
      {Session Convener}{AGU Fall Meeting, Session EP15}{2021}
    \resumeSmallThing
